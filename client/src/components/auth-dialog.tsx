      ...
      <DialogContent className="auth-dialog sm:max-w-md bg-black border-gray-600 p-8">
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          <Button
            ...
            className="w-full bg-gray-800 hover:bg-gray-700 text-white font-normal py-6 text-base flex items-center justify-center gap-3"
          >
          ...
          <Button
            ...
            className="w-full bg-white hover:bg-gray-100 text-black font-normal py-6 text-base"
          >
            {t.continueWithEmail} →
          </Button>
