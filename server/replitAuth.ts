...
if (!process.env.REPLIT_DOMAINS) {
  console.warn("Environment variable REPLIT_DOMAINS not provided - auth disabled");
}
...
export async function setupAuth(app: Express) {
  // Skip auth setup if not on Replit
  if (!process.env.REPLIT_DOMAINS) {
    console.log("Auth disabled - not running on Replit");
    return;
  }
