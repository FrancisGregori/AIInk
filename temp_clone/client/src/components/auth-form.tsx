    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-b from-black to-gray-900">
      <Card className="w-[400px] bg-gray-900 border-gray-800">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-white">TattooStencilPro AI</CardTitle>
          <CardDescription className="text-gray-400">
            Inicia sesión para acceder al generador de tatuajes con IA
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="signin" className="w-full">
            ...
            <TabsContent value="signin">
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="signin-password" className="text-gray-200">Contraseña</Label>
                  <Input
                    id="signin-password"
                    type="password"
                    placeholder="••••••••"
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignUp} className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="signup-password" className="text-gray-200">Contraseña</Label>
                  <Input
                    id="signup-password"
                    type="password"
        ...
        <CardFooter className="text-center">
          <p className="text-sm text-gray-400">
            Al registrarte, tus datos se compartirán entre el generador AI y el convertidor de stencil
          </p>
        </CardFooter>
      </Card>
    </div>
